...
const Register = () => {
  ...
  const handleGoogleSignup = async () => {
    ...
    if (result.error) {
      toast({ title: t("register.failed"), description: String(result.error), variant: "destructive" });
      return;
    }
            ...
            <>
              ...
              <div className="relative mb-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground font-body">{t("login.or")}</span>
                </div>
              </div>
