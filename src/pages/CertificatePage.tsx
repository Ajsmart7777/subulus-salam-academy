...
const CertificatePage = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.click();
      toast({ title: "Downloaded!", description: "Certificate saved as PNG." });
    } catch {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `I completed "${course?.title}" at Subulus-Salam Academy! Certificate #${certificate?.certificate_number}`,
          url: shareUrl,
        });
      } catch {
        // User cancelled
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container py-20 text-center">
          <h1 className="text-2xl font-heading font-bold text-foreground">Certificate not found</h1>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container py-8">
        {/* Back link */}
        <Link
          to={`/course/${certificate.course_id}`}
        ...
        <div className="text-center mb-6">
          <h1 className="text-3xl font-heading font-bold text-foreground">Your Certificate 🎉</h1>
        ...
        <div className="flex justify-center overflow-x-auto pb-8">
          <div className="shadow-elevated rounded-lg overflow-hidden">
            <CertificateTemplate
              ...
              courseNameAr={course?.title_ar ?? undefined}
